...
export class OurPartnersComponent implements OnInit,AfterViewInit, OnDestroy {
  cols: any[];
  ...
  formName = "Our Partners";
  dialogName = "Our Partners";
  formType = "OurPartners";
  fileFields = [];
  ...
  createFieldConfig(){
    ...
    this.arrGroupField = [
      ...
      {fieldId: 'logo', fieldName: 'Logo', showOnGrid: true, required: true,width: '14rem', fieldType: 'image'},
      {fieldId: 'link', fieldName: 'Link', showOnGrid: true, required: false,width: '14rem', fieldType: 'text'},
