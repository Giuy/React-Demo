...
import {  FileParameter, PhotoDto } from 'app/api-clients/general-client';
...
export class BannerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // bannerTypeList = [
  //   {
  //     value: BannerTypesEnum.BannerHomePage,
  //     name: 'Home Page',
  //   },
  //   {
  //     value: BannerTypesEnum.AdBanner,
  //     name: 'Advertisement',
  //   },
  //   {
  //     value: BannerTypesEnum.Information,
  //     name: 'Our Commitment',
  //   },
  //   {
  //     value: BannerTypesEnum.Others,
  //     name: 'Others',
  //   },
  // ];
  // positionList = [
  //   { value: BannerPosition.Left, name: 'Left' },
  //   { value: BannerPosition.Right, name: 'Right' },
  //   { value: BannerPosition.Top, name: 'Top' },
  //   { value: BannerPosition.Bottom, name: 'Bottom' },
  // ];
  ...
  createFieldConfig() {
    ...
    //     required: true,
    //     width: '14rem',
    //     selectData: this.bannerTypeList,
    //     showFilter: true,
    //     fieldType: 'select',
    //   },
    //   { fieldId: 'title', fieldName: 'Title', showOnGrid: true, required: true, width: '8rem', fieldType: 'text' },
    //   {
    //     fieldId: 'subtitle',
    //     fieldName: 'Sub Title',
    //     showOnGrid: false,
    ...
    //     fieldType: 'text',
    //   },
    //   { fieldId: 'image', fieldName: 'Image', showOnGrid: true, required: true, width: '10rem', fieldType: 'image' },
    //   {
    //     fieldId: 'position',
    //     fieldName: 'Position',
    //     showOnGrid: false,
    //     required: false,
    //     width: '5rem',
    //     selectData: this.positionList,
    //     fieldType: 'select',
    //   },
    //   {
    //     fieldId: 'showButton',
    //     fieldName: 'Show Button',
    //     showOnGrid: true,
    //     required: false,
    //     width: '10rem',
    //     fieldType: 'checkbox',
    ...
    //   {
    //     fieldId: 'buttonName',
    //     fieldName: 'Button Name',
    //     showOnGrid: true,
    //     required: false,
    //     width: '10rem',
    //     fieldType: 'text',
    //   },
    //   { fieldId: 'link', fieldName: 'Link', showOnGrid: false, required: false, width: '5rem', fieldType: 'text' },
    //   {
    //     fieldId: 'description',
    ...
    //     fieldType: 'checkbox',
    //   },
    //   //{fieldId: 'order', fieldName: 'Order', showOnGrid: false, required: false, fieldType: 'text'},
    // ];
  ...
  handleChangeActive(value, item: any, key: string) {
    /*
    if (key == 'isActived') {
